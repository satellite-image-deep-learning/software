...
* [overturemaps-py](https://github.com/OvertureMaps/overturemaps-py) -> CLI for extracting OpenStreetMap data and generating GeoJSON
...
* [AI Segmentation](https://github.com/TerraLabAI/QGIS_AI-Segmentation) -> click a building or tree on imagery to get its polygon, or name an object to extract all of them; a local mode runs SAM 2.1 on the CPU
...
* [brick-kiln-labeling-tool](https://github.com/rishabh-mondal/brick-kiln-labeling-tool) -> a streamlit app to label brick kilns in satellite imagery
